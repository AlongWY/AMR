...
def build_arg_parser2():
    """
    Build an argument g_parser using optparse. Use it when python version is 2.5 or 2.6.
    ...
    if sys.version_info[1] < 7:
        ...
        for file_path in args.f:
            if not os.path.exists(file_path):
                ...
                exit(1)
            file_handle.append(open(file_path, encoding='utf-8'))
        # use opened files
